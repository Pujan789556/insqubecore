...
// ACCOUNT PARTY TYPES
defined('IQB_AC_PARTY_TYPE_AGENT') 					OR define('IQB_AC_PARTY_TYPE_AGENT',				'AGENT');
defined('IQB_AC_PARTY_TYPE_COMPANY_BROKER') 		OR define('IQB_AC_PARTY_TYPE_COMPANY_BROKER',		'CMP_BROKER');
defined('IQB_AC_PARTY_TYPE_COMPANY_BANK') 			OR define('IQB_AC_PARTY_TYPE_COMPANY_BANK',			'CMP_BANK');
defined('IQB_AC_PARTY_TYPE_COMPANY_REINSURANCE') 	OR define('IQB_AC_PARTY_TYPE_COMPANY_REINSURANCE',	'CMP_REINSURANCE');
defined('IQB_AC_PARTY_TYPE_COMPANY_INSURANCE') 		OR define('IQB_AC_PARTY_TYPE_COMPANY_INSURANCE',	'CMP_INSURANCE');
defined('IQB_AC_PARTY_TYPE_COMPANY_GENERAL') 		OR define('IQB_AC_PARTY_TYPE_COMPANY_GENERAL',		'CMP_GENERAL');
defined('IQB_AC_PARTY_TYPE_CUSTOMER') 				OR define('IQB_AC_PARTY_TYPE_CUSTOMER',	'CUSTOMER');
defined('IQB_AC_PARTY_TYPE_SURVEYOR') 				OR define('IQB_AC_PARTY_TYPE_SURVEYOR',	'SURVEYOR');
defined('IQB_AC_PARTY_TYPE_GENERAL') 				OR define('IQB_AC_PARTY_TYPE_GENERAL',	'GENERAL');
defined('IQB_AC_PARTY_TYPES')    	OR define('IQB_AC_PARTY_TYPES', 	[
	...
	IQB_AC_PARTY_TYPE_COMPANY_BROKER		=> 'Company - Broker',
	IQB_AC_PARTY_TYPE_COMPANY_BANK			=> 'Company - Bank',
	IQB_AC_PARTY_TYPE_COMPANY_REINSURANCE	=> 'Company - Re-insurance',
	IQB_AC_PARTY_TYPE_COMPANY_INSURANCE		=> 'Company - Insurance',
	IQB_AC_PARTY_TYPE_COMPANY_GENERAL		=> 'Company - General',
