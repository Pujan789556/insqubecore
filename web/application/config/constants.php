...
define('IQB_SUB_PORTFOLIO_MISC_FG_ID', 		46); 	// Fidelity Guarantee
define('IQB_SUB_PORTFOLIO_MISC_GPA_ID', 	47); 	// Group Personnel Accident
define('IQB_SUB_PORTFOLIO_MISC_HI_ID', 		48); 	// Health Insurance (MISC)
...
defined('IQB_AC_ACCOUNT_ID_LIABILITY_BS_SERVICE_CHARGE') 	OR define('IQB_AC_ACCOUNT_ID_LIABILITY_BS_SERVICE_CHARGE', 	58);
defined('IQB_AC_ACCOUNT_ID_AGENCY_COMMISSION') 				OR define('IQB_AC_ACCOUNT_ID_AGENCY_COMMISSION', 			59);
defined('IQB_AC_ACCOUNT_ID_TDS_AGENCY_COMMISSION') 			OR define('IQB_AC_ACCOUNT_ID_TDS_AGENCY_COMMISSION', 		60);
defined('IQB_AC_ACCOUNT_ID_AGENCY_COMMISSION_PAYABLE') 		OR define('IQB_AC_ACCOUNT_ID_AGENCY_COMMISSION_PAYABLE', 	61);
defined('IQB_AC_ACCOUNT_ID_COLLECTION') 					OR define('IQB_AC_ACCOUNT_ID_COLLECTION', 					62);
defined('IQB_AC_ACCOUNT_ID_SERVICE_CHARGE_RECOVERY') 		OR define('IQB_AC_ACCOUNT_ID_SERVICE_CHARGE_RECOVERY', 		63);
defined('IQB_AC_ACCOUNT_ID_TDS_REINSURANCE') 				OR define('IQB_AC_ACCOUNT_ID_TDS_REINSURANCE',				64);
defined('IQB_AC_ACCOUNT_ID_PAYABLE_TO_REINSURER') 			OR define('IQB_AC_ACCOUNT_ID_PAYABLE_TO_REINSURER',			65);
defined('IQB_AC_ACCOUNT_ID_BS_AGR_PREMIUM_RECEIVABLE') 		OR define('IQB_AC_ACCOUNT_ID_BS_AGR_PREMIUM_RECEIVABLE',	66);

defined('IQB_AC_ACCOUNT_ID_SERVICE_CHARGE_REIMBURSED') 		OR define('IQB_AC_ACCOUNT_ID_SERVICE_CHARGE_REIMBURSED',	438);
defined('IQB_AC_ACCOUNT_ID_RECEIVABLE_FROM_LOCAL_INSURER') 	OR define('IQB_AC_ACCOUNT_ID_RECEIVABLE_FROM_LOCAL_INSURER',439);
defined('IQB_AC_ACCOUNT_ID_SURVEYOR_PARTY') 				OR define('IQB_AC_ACCOUNT_ID_SURVEYOR_PARTY',				440);
defined('IQB_AC_ACCOUNT_ID_CLAIM_PARTY') 					OR define('IQB_AC_ACCOUNT_ID_CLAIM_PARTY',					441);
defined('IQB_AC_ACCOUNT_ID_TDS_SURVEYOR') 					OR define('IQB_AC_ACCOUNT_ID_TDS_SURVEYOR',					442);
defined('IQB_AC_ACCOUNT_ID_PORTFOLIO_WITHDRAWL_ENTRY') 		OR define('IQB_AC_ACCOUNT_ID_PORTFOLIO_WITHDRAWL_ENTRY',	443);
