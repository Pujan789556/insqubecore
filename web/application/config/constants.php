...
define('IQB_FLAG_NOT_REQUIRED', 'X');
...
/*
|--------------------------------------------------------------------------
| PORTFOLIO SETTINGS - SHORT TERM APPLY FOR FLAG
|--------------------------------------------------------------------------
|
*/
define('IQB_PFS_FLAG_SHORT_TERM_APPLY_FOR_BASIC',  1);
define('IQB_PFS_FLAG_SHORT_TERM_APPLY_FOR_POOL',   2);

// SUB PORTFOLIO LIST
define('IQB_PFS_FLAG_SHORT_TERM_APPLY_FOR__LIST',  [
	IQB_PFS_FLAG_SHORT_TERM_APPLY_FOR_BASIC 	=> 'Basic Only',
	IQB_PFS_FLAG_SHORT_TERM_APPLY_FOR_POOL 		=> 'Both Basic and Pool'
]);
...
define('IQB_SUB_PORTFOLIO_MARINE_AIR_ROAD_TRANSIT_ID', 	504);	// Road Air Transit
...
define('IQB_PORTFOLIO__SUB_PORTFOLIO_LIST__MARINE',  [
	...
	IQB_SUB_PORTFOLIO_MARINE_AIR_ROAD_TRANSIT_ID 	=> 'Air/Road Transit',
...
|--------------------------------------------------------------------------
*/
defined('IQB_ENDORSEMENT_STATUS_DRAFT')          OR define('IQB_ENDORSEMENT_STATUS_DRAFT',        'D');
defined('IQB_ENDORSEMENT_STATUS_VERIFIED')       OR define('IQB_ENDORSEMENT_STATUS_VERIFIED',     'V');
defined('IQB_ENDORSEMENT_STATUS_RI_APPROVED')    OR define('IQB_ENDORSEMENT_STATUS_RI_APPROVED',  'R');
defined('IQB_ENDORSEMENT_STATUS_VOUCHERED')    	OR define('IQB_ENDORSEMENT_STATUS_VOUCHERED',  	'H');
defined('IQB_ENDORSEMENT_STATUS_INVOICED')    	OR define('IQB_ENDORSEMENT_STATUS_INVOICED',  	'I');
defined('IQB_ENDORSEMENT_STATUS_ACTIVE')         OR define('IQB_ENDORSEMENT_STATUS_ACTIVE',       'A');
...
|--------------------------------------------------------------------------
*/
defined('IQB_ENDORSEMENT_TYPE_FRESH')    		OR define('IQB_ENDORSEMENT_TYPE_FRESH',      	1);
defined('IQB_ENDORSEMENT_TYPE_TIME_EXTENDED')  	OR define('IQB_ENDORSEMENT_TYPE_TIME_EXTENDED',   2);

// OTHER ENDORSEMENTS
defined('IQB_ENDORSEMENT_TYPE_GENERAL')  			 OR define('IQB_ENDORSEMENT_TYPE_GENERAL',    			3);
defined('IQB_ENDORSEMENT_TYPE_OWNERSHIP_TRANSFER')	 OR define('IQB_ENDORSEMENT_TYPE_OWNERSHIP_TRANSFER', 	4);
defined('IQB_ENDORSEMENT_TYPE_PREMIUM_UPGRADE')  	 OR define('IQB_ENDORSEMENT_TYPE_PREMIUM_UPGRADE',    	5);
defined('IQB_ENDORSEMENT_TYPE_PREMIUM_REFUND')  	 OR define('IQB_ENDORSEMENT_TYPE_PREMIUM_REFUND',    	6);
defined('IQB_ENDORSEMENT_TYPE_TERMINATE')  			 OR define('IQB_ENDORSEMENT_TYPE_TERMINATE',    		7);
defined('IQB_ENDORSEMENT_TYPE_REFUND_AND_TERMINATE') OR define('IQB_ENDORSEMENT_TYPE_REFUND_AND_TERMINATE', 8);


/*
|--------------------------------------------------------------------------
| POLICY ENDORSEMENT COMPUTATION BASIS CONSTANTS - UP/DOWN
|--------------------------------------------------------------------------
*/
defined('IQB_ENDORSEMENT_CB_UPDOWN_FULL') 	 OR define('IQB_ENDORSEMENT_CB_UPDOWN_FULL',   	1);
defined('IQB_ENDORSEMENT_CB_UPDOWN_STR') 	 OR define('IQB_ENDORSEMENT_CB_UPDOWN_STR',   	2); // STR = SHORT TERM RATE
defined('IQB_ENDORSEMENT_CB_UPDOWN_PRORATA') OR define('IQB_ENDORSEMENT_CB_UPDOWN_PRORATA', 3);
defined('IQB_ENDORSEMENT_CB_UPDOWN_MANUAL')  OR define('IQB_ENDORSEMENT_CB_UPDOWN_MANUAL',  3);


/*
|--------------------------------------------------------------------------
| POLICY ENDORSEMENT COMPUTATION BASIS CONSTANTS - TIME EXTENSION
|--------------------------------------------------------------------------
*/
defined('IQB_ENDORSEMENT_CB_TE_DURATION_PRORATA') 	OR define('IQB_ENDORSEMENT_CB_TE_DURATION_PRORATA',   	1);
defined('IQB_ENDORSEMENT_CB_TE_NET_DIFF') 	 		OR define('IQB_ENDORSEMENT_CB_TE_NET_DIFF',   			2);
...
|
*/
define('IQB_ENDORSEMENT_SPR_CONFIG_BOTH',       1); 	// Applies on Basic and Pool Both Premium
...
// TREATY DISTRIBUTION BASIS
defined('IQB_RI_SETUP_TREATY_DISTRIBUTION_BASIS_SI')    	OR define('IQB_RI_SETUP_TREATY_DISTRIBUTION_BASIS_SI',	1);
defined('IQB_RI_SETUP_TREATY_DISTRIBUTION_BASIS_PREMIUM') 	OR define('IQB_RI_SETUP_TREATY_DISTRIBUTION_BASIS_PREMIUM',	2);
defined('IQB_RI_SETUP_TREATY_DISTRIBUTION_BASIS_TYPES')    	OR define('IQB_RI_SETUP_TREATY_DISTRIBUTION_BASIS_TYPES', 	[
	IQB_RI_SETUP_TREATY_DISTRIBUTION_BASIS_SI 		=> 'Sum Insured',
	IQB_RI_SETUP_TREATY_DISTRIBUTION_BASIS_PREMIUM 	=> 'Premium',
]);
...
// RI TRANSACTIONS - TYPE CONSTATNS
defined('IQB_RI_TXN_FOR_BASIC')  OR define('IQB_RI_TXN_FOR_BASIC', 1);
defined('IQB_RI_TXN_FOR_POOL')   OR define('IQB_RI_TXN_FOR_POOL',	 2);
defined('IQB_RI_TXN_FOR_TYPES')  OR define('IQB_RI_TXN_FOR_TYPES', 	[
	IQB_RI_TXN_FOR_BASIC 	=> 'Basic',
	IQB_RI_TXN_FOR_POOL 	=> 'Pool'
]);
