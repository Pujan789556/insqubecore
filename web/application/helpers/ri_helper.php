...
if ( ! function_exists('RI__valid_treaty_record'))
{
	...
	function RI__valid_treaty_record( $treaty_record )
	{
		...
		$comp_fields = ['ac_basic', 'treaty_distribution_for', 'flag_claim_recover_from_ri', 'flag_comp_cession_apply', 'comp_cession_percent', 'comp_cession_max_amt', 'treaty_max_capacity_amt'];
		$treaty_comp_fields = [];
