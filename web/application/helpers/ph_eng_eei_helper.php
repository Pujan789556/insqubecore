...
if ( ! function_exists('__save_premium_ENG_EEI'))
{
	 ...
	 * @return json
	 */
	function __save_premium_ENG_EEI($policy_record, $endorsement_record)
	{
		$CI =& get_instance();
		...
		if( $CI->input->post() )
		{
			 ...
			 */
			$validation_rules = _TXN_ENG_EEI_premium_validation_rules($policy_record, $pfs_record, $old_object, TRUE );
