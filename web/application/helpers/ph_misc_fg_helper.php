...
if ( ! function_exists('__save_premium_MISC_FG'))
{
	 ...
	 * @return json
	 */
	function __save_premium_MISC_FG($policy_record, $endorsement_record)
	{
		$CI =& get_instance();
		...
		if( $CI->input->post() )
		{
			 ...
			 */
			$validation_rules = _TXN_MISC_FG_premium_validation_rules($policy_record, $pfs_record, $old_object, TRUE );
