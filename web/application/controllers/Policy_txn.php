	...
	// --------------------------------------------------------------------
		...
		private function __save_premium($policy_record, $txn_record)
		{
			if( $this->input->post() )
			{
		        ...
		        {
		            $done = $this->__save_premium_AGR_FISH($policy_record, $txn_record);
		        }
		        ...
		        {
		            $done = $this->__save_premium_MISC_PL( $policy_record, $txn_record );
		        }
		 ...
		 * @return json
		 */
		private function __save_premium_AGR_FISH($policy_record, $txn_record)
		{
			/**
			 * Form Submitted?
			 */
		 ...
		 * @return json
		 */
		private function __save_premium_MISC_GPA($policy_record, $txn_record)
		{
			/**
			 * Form Submitted?
			 */
		 ...
		 * @return json
		 */
		private function __save_premium_MISC_PL($policy_record, $txn_record)
		{
			/**
			 * Form Submitted?
			 */
