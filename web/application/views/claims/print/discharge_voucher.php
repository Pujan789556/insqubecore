    ...
    $header_footer = '<htmlpageheader name="myheader" value="on">
                        <table class="table no-border">
                            <tr>
                                ...
                                <td align="right"><h2>दाबी फर्छ्यौट पूर्जा</h2></td>
                            </tr>
                        </table>
                    </htmlpageheader>
    ...
    <body>
        ...
        <div style="display:block; margin-left:30px; margin-right: 30px; margin-top:30px;">
            ...
            <table>
                ...
                <tr>
                    <td colspan="2"><p style="font-size: 9pt">खातावाल  र बिमितको नाम हुवहु मिलेको अबस्थामा मात्र माथि उल्लेख गरिएको खातामा रकम स्थानान्तरण गरीने छ । </p></td>
                </tr>
            </table><br>
