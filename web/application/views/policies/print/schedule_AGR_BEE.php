...
/**
 * Schedule Print : Agriculture - BEE
 */

$this->load->helper('ph_agr_bee');

$object_attributes  = json_decode($record->object_attributes);
$premium_attributes = json_decode($record->premium_attributes);

$schedule_table_title   = 'मौरीको बीमालेख';
...
<html>
    ...
    <body>
                ...
                <tr>
                    <td width="50%" class="no-padding">
                        <table class="table" width="100%">
                            ...
                            <tr>
                                <td>
                                    <strong>मौरी पालिएको खोरको वास्तविक ठेगाना</strong><br/>
        ...
        <table class="table">
            <?php
            $section_elements  = _OBJ_AGR_BEE_validation_rules($record->portfolio_id)['items'];
            $items              = $object_attributes->items ?? NULL;
            $item_count         = count( $items->sum_insured ?? [] );
            ?>
            <thead>
                <tr>
                    <td colspan="10" class="text-bold">बीमीत मौरीको विवरण</td>
                </tr>
                <tr>
