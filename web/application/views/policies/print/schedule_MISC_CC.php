...
/**
 * Schedule Print : MISCELLANEOUS - CASH IN COUNTER
 */
                    ...
                    <td width="50%" class="no-padding">
                        <table class="table">
                            ...
                            <tr>
                                <td>
                                    <?php
                                    $this->load->view('policy_transactions/snippets/_schedule_cost_calculation_table_risks_MISC_CC', ['txn_record' => $txn_record]);
                                    ?>
                                </td>
                            </tr>
                        </table>
