 ...
 */
if( !$flag__fresh_or_renewal && $record->status === IQB_POLICY_TXN_STATUS_VERIFIED && $this->dx_auth->is_authorized('policy_txn', 'status.to.draft') ): ?>
    <a href="#"
        title="Back to Draft"
        data-toggle="tooltip"
        data-confirm="true"
 ...
 * Status "to Verified"
 */
if( !$flag__fresh_or_renewal && $record->status === IQB_POLICY_TXN_STATUS_DRAFT && $this->dx_auth->is_authorized('policy_txn', 'status.to.verified') ): ?>
    <a href="#"
