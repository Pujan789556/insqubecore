                        ...
                        <tr>
                            <td width="100%" class="no-padding">
                                <table class="table" width="100%">
                                    <tr>
                                        <td>बीमा शुल्क</td>
                                        <td class="text-right"><?php echo number_format($record->amt_total_premium, 2, '.', ''); ?></td>
                                    </tr>
                                    <tr>
                                        <td>टिकट दस्तुर</td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-right"><strong><?php echo number_format( (float)( $record->amt_stamp_duty + $record->amt_total_premium + $record->amt_vat ) , 2, '.', '');?></strong></td>
                                    </tr>
                                </table>
                            </td>
                    <?php endif ?>
