				...
				<div class="row">
					...
					<div class="col-sm-6 master-actions text-right">
						<a href="#" title="Add new department"
							class="btn btn-success btn-round trg-dialog-edit" data-title='<i class="fa fa-pencil-square-o"></i> Add New Department' data-url="<?php echo site_url('departments/add/');?>" data-form=".form-iqb-general"
