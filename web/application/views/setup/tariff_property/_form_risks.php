...
<?php echo form_open( $this->uri->uri_string(),
    ...
    <div class="box box-solid box-bordered">
        <div class="box-header with-border">
            <h4 class="box-title">Property Risk/Rate Table</h4>
        </div>
        <div class="box-body">
                ...
                <tbody>
                    ...
                    if($risks):
                        foreach ($risks as $single):
                            ?>
                        <tr <?php echo $i == 0 ? 'id="__property_risk_row"' : '' ?>>
        ...
        <div class="box-footer bg-info">
            <a href="#" class="btn bg-teal" onclick="__duplicate_tr('#__property_risk_row', this)">Add More</a>
        </div>
    </div>
