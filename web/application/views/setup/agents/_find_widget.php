...
<div class="box box-solid no-margin">
	<div class="box-header no-border gray">
		<div class="row">
			<div class="col-sm-8">
				<h1 style="margin:0; font-size:24px;">Find Agent</h1>
			</div>
			<div class="col-sm-4 master-actions text-right">
				<?php if( $this->dx_auth->is_authorized('agents', 'add.agent') ): ?>
					<a href="#"
						title="Add New Agent"
						data-toggle="tooltip"
						...
						data-url="<?php echo site_url('agents/add/y/' . $widget_reference);?>"
						data-form="#_form-agent"
