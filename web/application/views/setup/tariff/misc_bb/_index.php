...
/**
* Portfolio Tariff - MISC (Banker's Blanket) : Index View
*/
?>
<div class="row">
	<div class="col-xs-12">
			...
			<div class="box-header gray">
				<div class="row">
					...
					<div class="col-sm-6 master-actions text-right">
						<a href="<?php echo site_url($this->data['_url_base'] . '/misc_bb/flush/');?>" title="Flush Cache"
						...
						<a href="#" title="Add New Banker's Blanket Tarrif"
							...
							data-url="<?php echo site_url($this->data['_url_base'] . '/misc_bb/add/');?>"
