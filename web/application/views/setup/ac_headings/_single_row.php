...
<tr class="searchable" data-id="<?php echo $record->id; ?>" id="_data-row-<?php echo $record->id;?>">
	...
	<td><?php echo $record->heading_group_name;?></td>
			...
			<ul class="dropdown-menu pull-right" role="menu">
				<li>
					<a href="#"
						...
						data-url="<?php echo site_url('ac_headings/edit/' . $record->id);?>"
						data-form=".form-iqb-general">
						<i class="fa fa-pencil-square-o"></i>
						<span>Edit Account Heading</span></a>
				</li>

				<?php if(safe_to_delete( 'Ac_heading_model', $record->id )):?>
					<li class="divider"></li>
					<li>
						<a href="#"
							title="Delete"
							...
							data-confirm="true"
							data-url="<?php echo site_url('ac_headings/delete/' . $record->id);?>">
