...
<div class="box box-primary">
	<div class="box-header with-border">
		...
		<a href="#"
        	...
        	title="Edit RI (Pool) Portfolios"
        	data-toggle="tooltip"
        	data-box-size="full-width"
        	data-title="<i class='fa fa-pencil-square-o'></i> Edit RI (Pool) Portfolios"
        	data-url="<?php echo site_url('ri_setup_pools/portfolios/'. $record->id)?>"
