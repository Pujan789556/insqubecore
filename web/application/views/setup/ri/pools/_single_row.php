...
<tr class="searchable <?php echo $current_class;?>"
	...
	<td>
		<a href="<?php echo site_url('ri_setup_pools/details/' . $record->id);?>" title="View Treaty (Pool) Details">
	...
	<td class="ins-action">
		<div class="btn-group">
			...
			<ul class="dropdown-menu pull-right" role="menu">
				<li>
					<a href="#"
						title="Edit Treaty (Pool)"
						class="trg-dialog-edit"
						data-box-size="large"
						data-title='<i class="fa fa-pencil-square-o"></i> Edit Treaty (Pool)'
						data-url="<?php echo site_url('ri_setup_pools/edit/' . $record->id);?>"
						data-form=".form-iqb-general">
						<i class="fa fa-pencil-square-o"></i>
						<span>Edit Treaty (Pool)</span></a>
				</li>
