				...
				<div class="row">
					...
					<div class="col-sm-6 master-actions text-right">
						<a href="#" title="Add new department"
							class="btn btn-success btn-round trg-dialog-edit" data-title='<i class="fa fa-pencil-square-o"></i> Add New Tag' data-url="<?php echo site_url($this->router->class . '/add/');?>" data-form=".form-iqb-general"
