	...
	<div class="col-xs-12">
		<div class="box">
				...
				<div class="row">
					...
					<div class="col-sm-6 master-actions text-right">
						<a href="#" title="Add new department"
							class="btn btn-success btn-round trg-dialog-edit" data-title='<i class="fa fa-pencil-square-o"></i> Add New Tag' data-url="<?php echo site_url( $this->data['_url_base'] . '/add/');?>" data-form=".form-iqb-general"
			...
			<div class="box-body table-responsive data-rows" id="iqb-data-list">
				 ...
				 * Load Rows from View
				 */
				$this->load->view('setup/tags/_list');
				?>
			</div>
			<!-- /.box-body -->
		</div>
