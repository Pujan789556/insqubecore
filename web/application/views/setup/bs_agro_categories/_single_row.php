...
<tr data-name="<?php echo $portfolio->name_en;?>" class="searchable" data-id="<?php echo $portfolio->id; ?>" id="_data-row-<?php echo $portfolio->id;?>">
	...
	<td><a href="<?php echo site_url('bs_agro_categories/details/' . $portfolio->id);?>"
			...
			<ul class="dropdown-menu pull-right" role="menu">
				<li>
					<a href="#"
						...
						data-url="<?php echo site_url('bs_agro_categories/edit/' . $portfolio->id);?>"
				...
				<li>
					<a href="<?php echo site_url('bs_agro_categories/details/' . $portfolio->id);?>"
