...
/**
 * Form : Object - MISCELLANEOUS - GROUP PERSONNEL ACCIDENT(GPA)
 */
?>
<style type="text/css">
    ...
    <div class="col-sm-12">
        <div class="box box-solid box-bordered scroll-x">
            ...
            <div class="box-footer bg-info">
                <a href="#" class="btn bg-teal" onclick="__duplicate_tr('#__gpa_items_row', this)">Add More</a>
            </div>
        </div>
    </div>
</div>
