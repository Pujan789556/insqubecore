...
/**
 * Form : Object - AGRICULTURE - BEE SUB-PORTFOLIO
 */
?>
<style type="text/css">
...
<div class="row">
    ...
    <div class="col-sm-12">
        <div class="box box-solid box-bordered">
            <div class="box-header with-border">
                <h4 class="box-title">मौरीको विवरण</h4>
            </div>
            <?php
            $js_breeds = [];
                    ...
                    <?php
                        if($item_count):
                            ...
                            foreach($items as $item_record):
                                ...
                                ?>
                                <tr <?php echo $i++ == 0 ? 'id="__bee_items_row"' : '' ?>>
            ...
            <div class="box-footer bg-info">
                <a href="#" class="btn bg-teal" onclick="__duplicate_tr('#__bee_items_row', this)">Add More</a>
            </div>
        </div>
    </div>
    ...
    <div class="col-sm-12">
        <div class="box box-solid box-bordered">
            <div class="box-header with-border">
                <h4 class="box-title">विगत १ वर्षमा तपाईंको मौरीमा भएको हानी नोक्सानीको विवरण</h4>
            </div>
            <?php
