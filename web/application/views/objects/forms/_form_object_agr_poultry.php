...
/**
 * Form : Object - AGRICULTURE - POULTRY SUB-PORTFOLIO
 */
?>
<style type="text/css">
    ...
    <div class="col-sm-12">
        <div class="box box-solid box-bordered">
                    ...
                    <?php
                        if($item_count):
                            ...
                            foreach($items as $item_record):
                                ...
                                ?>
                                <tr <?php echo $i++ == 0 ? 'id="__poultry_items_row"' : '' ?>>
            ...
            <div class="box-footer bg-info">
                <a href="#" class="btn bg-teal" onclick="__duplicate_tr('#__poultry_items_row', this)">Add More</a>
            </div>
        </div>
    </div>
