...
/**
 * Form : Object - AGRICULTURE - CROP SUB-PORTFOLIOS
 */
?>
<style type="text/css">
...
<div class="row">
    ...
    <div class="col-sm-12">
        <div class="box box-solid box-bordered">
            <div class="box-header with-border">
                <h4 class="box-title">बाली/फलफुलको विवरण</h4>
            </div>
            <?php
            $js_breeds = [];
                    ...
                    <?php
                        if($item_count):
                            ...
                            foreach($items as $item_record):
                                 ...
                                 * on EDIT mode
                                 */
                                $js_breeds[] = is_numeric($item_record->breed) ? $item_record->breed : '';
                                ?>
                                <tr <?php echo $i++ == 0 ? 'id="__crop_items_row"' : '' ?>>
            ...
            <div class="box-footer bg-info">
                <a href="#" class="btn bg-teal" onclick="__duplicate_tr('#__crop_items_row', this)">Add More</a>
            </div>
        </div>
    </div>
    ...
    <div class="col-sm-12">
        <div class="box box-solid box-bordered">
            <div class="box-header with-border">
                <h4 class="box-title">विगत १ वर्षमा तपाईंको बाली/फलफुलमा भएको हानी नोक्सानीको विवरण</h4>
            </div>
            <?php
                ...
                <tbody>
                    <?php
                        if($item_count):
                            ...
                            <tr <?php echo $i == 0 ? 'id="__crop_damages_row"' : '' ?>>
                                <?php foreach($section_elements as $single_element):?>
                                    <td>
                                        <?php
                                        /**
            ...
            <div class="box-footer bg-info">
                <a href="#" class="btn bg-teal" onclick="__duplicate_tr('#__crop_damages_row', this)">Add More</a>
            </div>
        </div>
    </div>
</div>
