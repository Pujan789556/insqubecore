...
/**
 * Form : Object - MISCELLANEOUS - FIDELITY GUARANTEE (FG)
 */
?>
<style type="text/css">
...
<div class="row">
        ...
        <div class="box box-solid box-bordered">
            ...
            <div class="box-body form-horizontal">
                ...
                <table class="table table-condensed table-bordered text-danger">
                    <thead>
                        <?php
                        $item_headings = _OBJ_MISC_FG_item_headings_dropdown();
                         ?>
                        <tr>
    ...
    <div class="col-sm-12">
        <div class="box box-solid box-bordered scroll-x">
            <div class="box-header with-border">
                <h4 class="box-title">Insured Staff List</h4>
            </div>
            <?php
                ...
                <tbody>
                    <?php
                        if($item_count):
                            ...
                            <tr <?php echo $i == 0 ? 'id="__fg_items_row"' : '' ?>>
                                    <td><?php echo ($i+1); ?></td>
            ...
            <div class="box-footer bg-info">
                <a href="#" class="btn bg-teal" onclick="__duplicate_tr('#__fg_items_row', this)">Add More</a>
            </div>
        </div>
    </div>
</div>
