...
/**
 * Form : Object - MISCELLANEOUS - EXPEDITION PERSONNEL ACCIDENT(EPA)
 */
?>
<style type="text/css">
...
<div class="row">
        ...
        <div class="box box-solid box-bordered">
            ...
            <div class="box-body form-horizontal">
                ...
                <table class="table table-condensed table-bordered text-danger">
                    <thead>
                        <?php
                        $item_headings = _OBJ_MISC_EPA_item_headings_dropdown();
                         ?>
                        <tr>
    ...
    <div class="col-sm-12">
        <div class="box box-solid box-bordered scroll-x">
            <div class="box-header with-border">
                <h4 class="box-title">Insured Personnel List</h4>
            </div>
            <?php
            ...
            <div class="box-footer bg-info">
                <a href="#" class="btn bg-teal" onclick="__duplicate_tr('#__epa_items_row', this)">Add More</a>
            </div>
        </div>
    </div>
</div>
