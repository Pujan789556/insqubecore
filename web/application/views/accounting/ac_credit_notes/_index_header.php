	...
	<div class="box-header no-border gray">
		<div class="row">
			...
			<div class="col-sm-4 master-actions text-right">
				<?php if( $this->dx_auth->is_authorized($this->router->class, 'add.credit_note') ): ?>
					<a href="#"
						title="Add New Credit Note"
						data-toggle="tooltip"
						class="btn btn-success btn-round trg-dialog-edit"
						data-box-size="full-width"
						data-title='<i class="fa fa-pencil-square-o"></i> Add New Credit Note'
						data-url="<?php echo site_url($this->data['_url_base'] . '/add/');?>"
						data-form="#__form-ac-credit_note"
