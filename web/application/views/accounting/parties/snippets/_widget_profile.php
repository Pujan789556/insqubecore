...
<div class="box box-bordered box-info" id="iqb-widget-ac_party-profile">
    <div class="box-header with-border border-dark">
        ...
        <span class="pull-left">
            ...
            <a href="<?php echo site_url('ac_parties/details/'.$record->id)?>" class="action" title="View Details" data-toggle="tooltip" target="_blank">
        ...
        <span class="pull-right">
            <?php if( $this->dx_auth->is_authorized('ac_parties', 'edit.ac_party') ): ?>
                <a href="#"
                    ...
                    data-url="<?php echo site_url('ac_parties/edit/' . $record->id . '/y');?>"
    ...
    <div class="box-body bg-gray-light">
        ...
        * Customer Overview
        */
        $this->load->view('ac_parties/snippets/_profile_card', ['record' => $record]);
        ?>
