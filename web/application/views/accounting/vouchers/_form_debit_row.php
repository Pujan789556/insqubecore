...
<?php endif;?>
    <td>
        <div class="form-group">
            ...
            <input type="hidden" name="account_id[dr][]" value="<?php echo $row ? $row->account_id : '';?>" data-field="account_id">
        </div>
    </td>
    <td>
        <div class="form-group">
            ...
            <input type="hidden" name="party_id[dr][]" value="<?php echo $row ? $row->party_id : '';?>" data-field="party_id">
        </div>
    </td>
