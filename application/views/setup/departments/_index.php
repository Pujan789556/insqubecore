				...
				<div class="row">
					...
					<div class="col-sm-6">
						<a href="#" title="Add new role"
							class="btn btn-success pull-right trg-dialog-edit" data-title='<i class="fa fa-pencil-square-o"></i> Add New Department' data-url="<?php echo site_url('departments/add/');?>" data-form=".form-iqb-general"
