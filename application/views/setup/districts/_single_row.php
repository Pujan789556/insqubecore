...
<tr data-name="<?php echo $record->name_en;?>" class="searchable" data-id="<?php echo $record->id; ?>" id="_dst-row-<?php echo $record->id;?>">
	...
	<td>
		<a href="#" title="Edit" class="trg-dialog-edit" data-title='<i class="fa fa-pencil-square-o"></i> Edit District' data-url="<?php echo site_url('districts/edit/' . $record->id);?>" data-form=".form-iqb-general" data-toggle="tooltip">
