...
$config['DX_website_name'] = 'InsQube';
$config['DX_webmaster_email'] = 'admin@example.com';

/*
|--------------------------------------------------------------------------
| Security settings (PHPass Library Config)
|--------------------------------------------------------------------------
...
// Forms view
$config['DX_login_view'] = 'auth/_form_login';
$config['DX_register_view'] = 'auth/_form_register';
$config['DX_forgot_password_view'] = 'auth/_form_forgot_password';
$config['DX_change_password_view'] = 'auth/_form_change_password';
$config['DX_cancel_account_view'] = 'auth/_form_cancel_account';

// Pages view
$config['DX_deny_view'] = 'auth/_auth_message';
$config['DX_banned_view'] = 'auth/_auth_message';
$config['DX_logged_in_view'] = 'auth/_auth_message';
$config['DX_logout_view'] = 'auth/_auth_message';

$config['DX_register_success_view'] = 'auth/_auth_message';
$config['DX_activate_success_view'] = 'auth/_auth_message';
$config['DX_forgot_password_success_view'] = 'auth/_auth_message';
$config['DX_reset_password_success_view'] = 'auth/_auth_message';
$config['DX_change_password_success_view'] = 'auth/_auth_message';

$config['DX_register_disabled_view'] = 'auth/_auth_message';
$config['DX_activate_failed_view'] = 'auth/_auth_message';
$config['DX_reset_password_failed_view'] = 'auth/_auth_message';
